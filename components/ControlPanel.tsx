...
export const ControlPanel: React.FC<Props> = ({ 
  ...
  return (
    <div className="w-full liquid-glass-strong border-b border-white/5 flex flex-col md:flex-row items-center justify-between px-4 py-3 md:py-0 md:h-[72px] z-50 sticky top-0 gap-3 md:gap-0 transition-all duration-500 ease-out-expo">
      
      {/* 1. LEFT: Brand */}
      <div className="flex items-center justify-between w-full md:w-auto md:justify-start">
        <div className="flex items-center gap-3 group cursor-default">
            <ViictorNLogo className="w-10 h-10 drop-shadow-[0_0_15px_rgba(255,255,255,0.1)] group-hover:drop-shadow-[0_0_20px_rgba(145,70,255,0.4)] transition-all duration-500" />
        ...
        <button
            ...
            className="md:hidden p-2 rounded-full bg-white/5 text-white/70 hover:bg-white/10 active:scale-95 transition-transform"
        >
      ...
      <div className="w-full md:w-auto flex justify-center">
        <div className="flex p-1 bg-black rounded-full border border-white/5 w-full md:w-auto shadow-inner shadow-white/5">
            <button
                onClick={() => onSetPlayer('twitch')}
                className={`flex-1 md:flex-none flex items-center justify-center gap-2 px-6 py-2 rounded-full text-xs font-bold transition-all duration-500 ease-out-expo ${activePlayer === 'twitch' ? 'bg-[#9146FF] text-white shadow-[0_0_20px_rgba(145,70,255,0.4)]' : 'text-gray-500 hover:text-gray-300'}`}
            >
            ...
            <button
                ...
                className={`flex-1 md:flex-none flex items-center justify-center gap-2 px-6 py-2 rounded-full text-xs font-bold transition-all duration-500 ease-out-expo ${activePlayer === 'kick' ? 'bg-[#53FC18] text-black shadow-[0_0_20px_rgba(83,252,24,0.4)]' : 'text-gray-500 hover:text-gray-300'}`}
            >
            ...
            <button
                ...
                className={`flex-1 md:flex-none flex items-center justify-center gap-2 px-6 py-2 rounded-full text-xs font-bold transition-all duration-500 ease-out-expo ${activePlayer === 'none' ? 'bg-white/10 text-white shadow-[0_0_15px_rgba(255,255,255,0.1)]' : 'text-gray-500 hover:text-gray-300'}`}
            >
                Chat
            </button>
        </div>
